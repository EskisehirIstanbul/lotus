        ...
        <div class="col-md-9">
          ...
          <div class="card card-primary card-outline" style="height: 550px;">
            ...
            <div class="card-header">
              <h3 class="card-title" style="color:#0e163d;">
                Outgoing Messages
              </h3>
            </div>
            <!-- /.card-header -->
              ...
              <div class="table-responsive mailbox-messages">
                ...
                <table class="table table-striped">
                  ...
                  <tbody><tr class="new-message">
                    ...
                    <td width="100"><a href="#" class="btn btn-sm text-white" style="background-color:#0e163d;"><i class="fa fa-search"></i></a> <a href="#" onclick="return confirm('You are deleting, if you confirm deletion will be done. This cannot be undone!!');" class="btn btn-sm btn-danger" style="margin-left: 3px;"><i class="fa fa-trash-o"></i></a></td>
                  </tr>
